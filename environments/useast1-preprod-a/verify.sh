...
# Post-deploy verification for CRE-6630 on useast1-preprod-a (preprod namespace).
#
# Usage:
#   export KUBECONFIG=/path/to/useast1_preprod_a.config
#   bash environments/useast1-preprod-a/verify.sh
...
echo "=== CRE-6630 Verification: ${NAMESPACE} on useast1-preprod-a ==="
echo ""
