...
# Uninstall CRE-6630 Helm releases from preprod namespace on uswest2-preprod-a.
#
# Usage:
#   export KUBECONFIG=/path/to/uswest2_preprod_a.config
#   bash environments/uswest2-preprod-a/cleanup.sh

NAMESPACE="${NAMESPACE:-preprod}"

echo "=== Cleanup CRE-6630 from ${NAMESPACE} on uswest2-preprod-a ==="
echo ""
